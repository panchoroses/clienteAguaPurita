<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sugerencia.aspx.cs" Inherits="clienteAguaPurita.sugerencia" %>
            ...
            <tr>
                <td>
                  <asp:TextBox ID="txtNombre" placeholder="Ingrese su nombre" runat="server" CssClass="auto-style6"></asp:TextBox>
                    ...
                    <asp:Label ID="lblComentario" runat="server" CssClass="auto-style9" Text="Sugerencia"></asp:Label>
                    <asp:Button ID="btnEnviarSugerencia" runat="server" CssClass="auto-style10" OnClick="btnEnviarSugerencia_Click" Text="Sugerir" />
                    <asp:TextBox ID="txtID"  placeholder="Ingrese su ID" runat="server" CssClass="auto-style11"></asp:TextBox>
                    <strong>
                    <asp:Label ID="lblSugerenciaTitulo" runat="server" CssClass="auto-style13" Text="Dejanos tu sugerencia"></asp:Label>
                    </strong>
