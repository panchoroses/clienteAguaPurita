...
{
    public partial class compraDispensadorUSB : System.Web.UI.Page
    {
        SqlConnection cnn;
        SqlCommand cmd;
        SqlDataReader dr;
        ...
        protected void btnComprar_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand();
            cmd.Connection = cnn;
            cmd.CommandText = "insert into venta values('" + txtFechaCompraDispensadorUSB.Text + "','" + txtIDCliente.Text + "','" + pagoId.Text + "','" + txtDispensadorUSBID.Text + "','" + txtIDNumDispensadorUSB.Text + "')";
