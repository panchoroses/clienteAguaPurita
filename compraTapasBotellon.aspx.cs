...
{
    public partial class compraTapasBotellon : System.Web.UI.Page
    {
        SqlConnection cnn;
        SqlCommand cmd;
        SqlDataReader dr;
        ...
        protected void btnComprar_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand();
            cmd.Connection = cnn;
            cmd.CommandText = "insert into venta values('" + txtFechaCompraTapas.Text + "','" + txtIDCliente.Text + "','" + pagoId.Text + "','" + txtTapaBotellonID.Text + "','" + txtIDNumTapasBotellon.Text + "')";
