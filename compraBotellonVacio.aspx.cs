...
{
    public partial class compraBotellonVacio : System.Web.UI.Page
    {
        SqlConnection cnn;
        SqlCommand cmd;
        SqlDataReader dr;
        ...
        protected void btnComprar_Click(object sender, EventArgs e)
        {
            ...
            cmd = new SqlCommand();
            cmd.Connection = cnn;
            cmd.CommandText = "insert into venta values('" + txtFechaCompraBotellonVacio.Text + "','" + txtIDCliente.Text + "','" + pagoId.Text + "','" + txtBotellonVacioID.Text + "','" + txtIDNumBotellonVacio.Text + "')";
